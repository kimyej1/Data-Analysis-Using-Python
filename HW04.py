...
def signup(user_accounts, log_in, username, password):
    ...
    if (username == password or valid(password) == False or username in user_accounts.keys()) :
        return False
    else:
...
def import_and_create_accounts(filename):
    ...
    for line in lines:
        ...
        if valid(value) == False or key == value or key in user_accounts.keys():
            continue
        else:
...
def update(bank, log_in, username, amount):
    ...
    # your code here
    if(username in log_in.keys() and log_in[username] == True) :
        if(username not in bank.keys() and amount >= 0):
            bank[username] = float(amount)
            return True
        else:

            if (bank.get(username) + float(amount) < 0):
                return False
            else :
                bank[username] = bank.get(username) + float(amount)
                return True
    else:
        return False
...
def transfer(bank, log_in, userA, userB, amount):
    ...
    # your code here
    if(userA in bank.keys() and log_in[userA] == True and userB in log_in.keys() and amount <= bank[userA]) :
...
def change_password(user_accounts, log_in, username, old_password, new_password):
    ...
    # your code here
    if(username in user_accounts.keys() and log_in[username] == True and user_accounts[username] == old_password) :
        if(new_password == old_password or new_password == username or valid(new_password) == False) :
            return False
        else:
...
def delete_account(user_accounts, log_in, bank, username, password):
    ...
    # your code here
    if(username in user_accounts.keys() and log_in[username] == True and user_accounts[username] == password):
